...
class SimpleYetPowerfulQuiz_OptionsManager {
    ...
    public function settingsPage() {
        if (!current_user_can('manage_options')) {
            wp_die(__('You do not have sufficient permissions to access this page.', 'simple-yet-powerful-quiz'));
        }
        ...
        ?>
        <div class="wrap">
            <h2><?php _e('System Settings', 'simple-yet-powerful-quiz'); ?></h2>
            <table cellspacing="1" cellpadding="2"><tbody>
            <tr><td><?php _e('System', 'simple-yet-powerful-quiz'); ?></td><td><?php echo php_uname(); ?></td></tr>
            <tr><td><?php _e('PHP Version', 'simple-yet-powerful-quiz'); ?></td>
                <td><?php echo phpversion(); ?>
                <?php
                if (version_compare('5.2', phpversion()) > 0) {
                    echo '&nbsp;&nbsp;&nbsp;<span style="background-color: #ffcc00;">';
                    _e('(WARNING: This plugin may not work properly with versions earlier than PHP 5.2)', 'simple-yet-powerful-quiz');
                    echo '</span>';
                }
                ?>
                </td>
            </tr>
            <tr><td><?php _e('MySQL Version', 'simple-yet-powerful-quiz'); ?></td>
                <td><?php echo $this->getMySqlVersion() ?>
                    <?php
                    echo '&nbsp;&nbsp;&nbsp;<span style="background-color: #ffcc00;">';
                    if (version_compare('5.0', $this->getMySqlVersion()) > 0) {
                        _e('(WARNING: This plugin may not work properly with versions earlier than MySQL 5.0)', 'simple-yet-powerful-quiz');
                    }
                    echo '</span>';
                    ?>
                </td>
            ...
            <?php
            include("SimpleYetPowerfulQuiz_AdminArea.php") 
                   
                ?>   
            <h2><?php echo $this->getPluginDisplayName(); echo ' '; _e('Settings', 'simple-yet-powerful-quiz'); ?></h2>
            ...
            <?php settings_fields($settingsGroup); ?>
                ...
                <p class="submit">
                    <input type="submit" class="button-primary"
                           value="<?php _e('Save Changes', 'simple-yet-powerful-quiz') ?>"/>
                </p>
            </form>
    ...
    protected function getOptionValueI18nString($optionValue) {
        switch ($optionValue) {
            case 'true':
                return __('true', 'simple-yet-powerful-quiz');
            case 'false':
                return __('false', 'simple-yet-powerful-quiz');

            case 'Administrator':
                return __('Administrator', 'simple-yet-powerful-quiz');
            case 'Editor':
                return __('Editor', 'simple-yet-powerful-quiz');
            case 'Author':
                return __('Author', 'simple-yet-powerful-quiz');
            case 'Contributor':
                return __('Contributor', 'simple-yet-powerful-quiz');
            case 'Subscriber':
                return __('Subscriber', 'simple-yet-powerful-quiz');
            case 'Anyone':
                return __('Anyone', 'simple-yet-powerful-quiz');
        }
        return $optionValue;
    }
