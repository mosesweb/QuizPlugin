...
class SimpleYetPowerfulQuiz_HelloWorldShortCode extends SimpleYetPowerfulQuiz_ShortCodeLoader {
   /**
   ...
   public function handleShortcode($atts) {
    ...
    {
        $category_variable = "body-parts";
    }
 
    

    $moretext = "<h1 class=\"quizheadline\">$current_catname Vocabulary Quiz</h1> | <a href=\"/words/$category_variable\" target=\"_blank\">Word List</a>";
    if($quiz_extra != NULL)
    {
        $moretext .= "<div class=\"quiz-extra\">" . $quiz_extra . "</div>";
    }
    echo "<div class=\"quizheader\"><div class=\"vocabname\">$category_variable</div>$moretext
    </div>"; ?>
    <?php
